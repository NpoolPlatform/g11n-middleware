# Npool g11n middleware

[![Test](https://github.com/NpoolPlatform/g11n-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/g11n-middleware/actions/workflows/main.yml)
...
* make g11n-middleware ```单独编译服务```
* make g11n-middleware-image ```单独生成服务镜像```
